...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<MusteriCirolariView> MusteriCirolariViews { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("server=.;Database=Northwind;Trusted_Connection=true;Trust Server Certificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MusteriCirolariView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("MusteriCirolariView");
            ...
            entity.Property(e => e.LastName).HasMaxLength(20);
            entity.Property(e => e.Musteri).HasMaxLength(40);
            entity.Property(e => e.OrderId).HasColumnName("OrderID");
            entity.Property(e => e.ShipCity).HasMaxLength(15);
            entity.Property(e => e.ShipCountry).HasMaxLength(15);
        });
        ...
        modelBuilder.Entity<OrderDetail>(entity =>
        {
            ...
            entity.ToTable("Order Details", tb => tb.HasTrigger("CheckProduct"));
