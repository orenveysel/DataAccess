...
namespace _11_GlobalQueryFilter.Configurations
{
    public class PersonData : IEntityTypeConfiguration<Person>
    {
        public void Configure(EntityTypeBuilder<Person> builder)
        {
            ...
            {
                new(){PersonId=1,Name="Ali",IsDeleted=false },
                new(){PersonId=2,Name="Veli",IsDeleted=false },
                new(){PersonId=3,Name="Ayse",IsDeleted=false },
                new(){PersonId=4,Name="Fatma",IsDeleted=false },
                new(){PersonId=5,Name="Hasan",IsDeleted=false },
                new(){PersonId=6,Name="Huseyin",IsDeleted=false },
                new(){PersonId=7,Name="Lale",IsDeleted=false },
                new(){PersonId=8,Name="Fadime",IsDeleted=false },
                new(){PersonId=9,Name="Suleyman",IsDeleted=false }
            });
